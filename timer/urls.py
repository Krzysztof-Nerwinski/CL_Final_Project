...
from timer.views import TimerView, timer_stop, TimerListView, TimerDetailedView, timer_pause, TimerEditView, \
    TimerAddView, TimerActiveView, TimerDeleteView, timer_unpause
...
urlpatterns = [
    ...
    path('timer/pause/<int:timer_id>/', timer_pause, name="timer_pause"),
    path('timer/unpause/<int:timer_id>/', timer_unpause, name="timer_unpause"),
